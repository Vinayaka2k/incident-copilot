...
app = FastAPI(
    ...
    description="Fast API service for incidentcopilot using Langgraph + hybrid retreival and Gemini",
    version="1.0.0"
)

class IncidentRequest(BaseModel):
    incident: str = Field(..., min_length=1, description="Raw incident description from the user")
